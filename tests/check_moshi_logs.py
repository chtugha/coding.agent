...
def view_logs():
    print("Starting Playwright script for checking Moshi logs...", flush=True)
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(2000)
        page.screenshot(path="/tmp/pw_logs_tab.png")

        # Select MOSHI_SERVICE filter
        print("Filtering by MOSHI_SERVICE...", flush=True)
        page.select_option("#logServiceFilter", "MOSHI_SERVICE")
        page.wait_for_timeout(5000)
        page.screenshot(path="/tmp/pw_moshi_logs.png")
