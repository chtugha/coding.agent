#!/usr/bin/env python3
"""
Run MFA alignment on cleaned episodes 150-159.
Based on run_mfa_on_cleaned_ep151.py
"""
...
def process_episode(episode_num):
    ...
    # Create MFA corpus directory structure on external drive to avoid disk space issues
...
def main():
    """Process episodes 150-159"""
    print("=" * 70)
    print("MFA Alignment - Episodes 150-159")
    print("=" * 70)
    print()
    
    results = {}
    for episode_num in range(150, 160):
