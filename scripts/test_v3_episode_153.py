#!/usr/bin/env python3
"""Test V3 waveform alignment on episode 153 for comparison with V4"""
...
output_path = "/tmp/fixed_alignment_test/episode_153_cleaned_v3.wav"
regions_path = "/tmp/fixed_alignment_test/episode_153_kept_regions_v3.json"

print("="*80)
print("Testing V3 Waveform Alignment - Episode 153")
print("="*80)
