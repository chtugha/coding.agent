...
@media (max-width:1024px){.wt-content{padding:16px 20px}.wt-metrics-grid{grid-template-columns:repeat(2,1fr)}.wt-dashboard-content{grid-template-columns:1fr}.wt-metric-card .metric-value{font-size:32px}.pfu-grid{grid-template-columns:auto 12px 1fr 12px auto}.pfu-path .wt-pipeline-node{width:52px;height:52px}.pfu-path .wt-pipeline-node .node-label{font-size:8px}.pfu-path-label{font-size:7px;margin-left:4px}}
@media (max-width:768px){.wt-sidebar{width:48px;min-width:48px}.wt-sidebar:hover{width:48px;min-width:48px}.wt-sidebar .nav-text,.wt-sidebar-section-title,.wt-sidebar-header .header-text{display:none !important}.wt-nav-item{justify-content:center;padding:12px 0;border-left:none}.wt-nav-item .nav-badge{display:none}.wt-metric-card .metric-value{font-size:28px}.pfu-grid{grid-template-columns:auto 8px 1fr 8px auto}.pfu-path .wt-pipeline-node{width:44px;height:44px}.pfu-path .wt-pipeline-node .node-label{font-size:7px}.pfu-path-label{display:none}.pfu-path-classic{flex-wrap:wrap;justify-content:center}}
...
.pfu-left-stem .wt-pipeline-connector,.pfu-right-stem .wt-pipeline-connector{width:1px;min-height:12px;max-width:none;flex:1 0 12px;background:linear-gradient(180deg,var(--wt-accent),var(--wt-accent-cyan));animation:flowPulse 2s infinite}
.pfu-left-stem .wt-pipeline-connector::after,.pfu-right-stem .wt-pipeline-connector::after{content:'\25BE';position:absolute;left:-4px;bottom:-8px;right:auto;top:auto;color:var(--wt-accent-cyan);font-size:14px}
...
:root{--wt-sidebar-width:0px;--wt-sidebar-expanded:0px}
.wt-sidebar{display:none}
.wt-content{padding:8px 6px;max-width:100%}
.wt-tab-bar{flex-wrap:wrap;gap:2px}
.wt-tab-btn{font-size:10px;padding:4px 6px;flex:1 1 auto;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.wt-card{padding:8px;overflow-x:auto}
.wt-card-header{padding:6px 8px;margin:-8px -8px 8px -8px;flex-wrap:wrap}
.wt-page-title{font-size:16px;margin-bottom:10px}
.wt-table{font-size:10px;display:block;overflow-x:auto}
.wt-table th,.wt-table td{padding:4px 6px}
.wt-btn{font-size:10px;padding:4px 8px}
.wt-btn-sm{font-size:9px;padding:3px 6px}
.wt-input,.wt-select{font-size:11px;padding:4px 6px;max-width:100%}
.wt-main{overflow-y:auto;overflow-x:hidden}
