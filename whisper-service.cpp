...
public:
    ...
    bool init() {
        ...
        log_fwd_.forward(whispertalk::LogLevel::INFO, 0, "Whisper Service initialized and running");
...
private:
    ...
    void send_or_buffer_llama(whispertalk::Packet& pkt, uint32_t call_id) {
